...
int main(int argc, char **argv)
{
    ...
    test_binary_op(input0, input1, output, params, CSINN_QUANT_FLOAT32, csinn_mul_init, csinn_mul,
                   &difference);
#elif (DTYPE==16)
    test_binary_op(input0, input1, output, params, CSINN_QUANT_FLOAT16, csinn_mul_init, csinn_mul,
                   &difference);
#elif (DTYPE==8)
    test_binary_op(input0, input1, output, params, CSINN_QUANT_INT8_ASYM, csinn_mul_init, csinn_mul,
                   &difference);
#endif
