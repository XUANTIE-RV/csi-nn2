...
#if (DTYPE == 32)
    test_unary_op(input, output, params, CSINN_QUANT_FLOAT32, csinn_reduce_sum_init,
                  csinn_reduce_sum, &difference);
#elif (DTYPE == 16)
    test_unary_op(input, output, params, CSINN_QUANT_FLOAT16, csinn_reduce_sum_init,
                  csinn_reduce_sum, &difference);
#elif (DTYPE == 8)
    test_unary_op(input, output, params, CSINN_QUANT_INT8_ASYM, csinn_reduce_sum_init,
                  csinn_reduce_sum, &difference);
#endif
