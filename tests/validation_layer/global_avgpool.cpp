...
//                   csinn_global_avgpool2d_init, csinn_global_avgpool2d, &difference);
// #elif (DTYPE == 16)
...
/* CSINN_RM_LAYER */
#if (DTYPE == 32)
    test_unary_layer(input, output, params, CSINN_QUANT_FLOAT32, csinn_global_avgpool2d_init,
                     csinn_global_avgpool2d, &difference);
#elif (DTYPE == 16)
    test_unary_layer(input, output, params, CSINN_QUANT_FLOAT16, csinn_global_avgpool2d_init,
                     csinn_global_avgpool2d, &difference);
#elif (DTYPE == 8)
    test_unary_layer(input, output, params, CSINN_QUANT_INT8_ASYM, csinn_global_avgpool2d_init,
                     csinn_global_avgpool2d, &difference);
#endif
