...
#if (DTYPE==32)
    test_unary_op(input, output, params, CSINN_QUANT_FLOAT32, csinn_relu1_init, csinn_relu1,
                    &difference);
#elif (DTYPE==16)
    test_unary_op(input, output, params, CSINN_QUANT_FLOAT16, csinn_relu1_init, csinn_relu1,
                  &difference);
#elif (DTYPE==8)
    test_unary_op(input, output, params, CSINN_QUANT_INT8_ASYM, csinn_relu1_init, csinn_relu1,
                  &difference);
#endif
