...
{
    init_testsuite("Testing function of and(anole).\n");
    ...
    if (csi_and_init(input0, input1, output, &params) != CSINN_TRUE) {
        printf("and init fail.\n\t");
        return -1;
    }
    ...
    csi_and(input0, input1, output, &params);
