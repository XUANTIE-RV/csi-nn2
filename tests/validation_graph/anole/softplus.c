...
{
    init_testsuite("Testing function of softplus(anole).\n");
    ...
    output->dim[1]  = input->dim[1];    // channel
    output->dim[2]  = input->dim[2];    // height
    output->dim[3]  = input->dim[3];    // width
    output->dim_count = 4;
