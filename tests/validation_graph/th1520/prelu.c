...
void test_i8_sym(struct csinn_tensor *input, struct csinn_tensor *alpha,
                 struct csinn_tensor *output, struct csinn_prelu_params *params, float difference)
{
    ...
    struct csinn_tensor *qinput0 = convert_f32_input(input, test_dtype, sess);
    struct csinn_tensor *qinput1 = convert_f32_input(alpha, test_dtype, sess);
...
void test_i16_sym(struct csinn_tensor *input, struct csinn_tensor *alpha,
                  struct csinn_tensor *output, struct csinn_prelu_params *params, float difference)
{
...
void test_i8_asym(struct csinn_tensor *input, struct csinn_tensor *alpha,
                  struct csinn_tensor *output, struct csinn_prelu_params *params, float difference)
{
...
void test_u8_asym(struct csinn_tensor *input, struct csinn_tensor *alpha,
                  struct csinn_tensor *output, struct csinn_prelu_params *params, float difference)
{
