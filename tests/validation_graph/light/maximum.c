...
void test_i8_sym(struct csi_tensor *input0, struct csi_tensor *input1, struct csi_tensor *output,
                 struct diso_params *params, float difference)
{
    printf("test maximum i8 sym\n");
...
void test_i16_sym(struct csi_tensor *input0, struct csi_tensor *input1, struct csi_tensor *output,
                  struct diso_params *params, float difference)
{
    printf("test maximum i16 sym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
