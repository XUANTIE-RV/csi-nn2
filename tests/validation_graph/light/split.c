...
void test_i8_sym(struct csi_tensor *input, struct csi_tensor **output, struct split_params *params,
                 float difference)
{
...
void test_i16_sym(struct csi_tensor *input, struct csi_tensor **output, struct split_params *params,
                 float difference)
{
...
void test_i8_asym(struct csi_tensor *input, struct csi_tensor **output, struct split_params *params,
                 float difference)
{
...
void test_u8_asym(struct csi_tensor *input, struct csi_tensor **output, struct split_params *params,
                 float difference)
{
