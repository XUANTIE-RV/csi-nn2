...
void test_i8_sym(struct csi_tensor *input, struct csi_tensor *output, struct lrn_params *params,
                 float difference)
{
    printf("test lrn i8 sym\n");
...
void test_i16_sym(struct csi_tensor *input, struct csi_tensor *output, struct lrn_params *params,
                 float difference)
{
    printf("test lrn i16 sym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
...
void test_i8_asym(struct csi_tensor *input, struct csi_tensor *output, struct lrn_params *params,
                 float difference)
{
    printf("test lrn i8 asym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
...
void test_u8_asym(struct csi_tensor *input, struct csi_tensor *output, struct lrn_params *params,
                 float difference)
{
    printf("test lrn u8 asym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
