...
void test_i8_sym(struct csi_tensor *input, struct csi_tensor *output, struct flatten_params *params,
                 float difference)
{
...
void test_i16_sym(struct csi_tensor *input, struct csi_tensor *output, struct flatten_params *params,
                 float difference)
{
...
void test_i8_asym(struct csi_tensor *input, struct csi_tensor *output, struct flatten_params *params,
                 float difference)
{
    printf("test flatten i8 sym\n");
    struct csi_session *sess = csi_alloc_session();
...
void test_u8_asym(struct csi_tensor *input, struct csi_tensor *output, struct flatten_params *params,
                 float difference)
{
