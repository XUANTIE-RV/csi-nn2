...
void test_i8_sym(struct csi_tensor *input, struct csi_tensor *alpha, struct csi_tensor *output,
                 struct prelu_params *params, float difference)
{
    printf("test prelu i8 sym\n");
    ...
    struct csi_tensor *qinput0 = convert_f32_input(input, test_dtype, sess);
    struct csi_tensor *qinput1 = convert_f32_input(alpha, test_dtype, sess);
    ...
    op_test_run(qinput0, qinput1, qoutput, params, sess, real_input, output->data,
                difference);
}

void test_i16_sym(struct csi_tensor *input, struct csi_tensor *alpha, struct csi_tensor *output,
                  struct prelu_params *params, float difference)
{
    printf("test prelu i16 sym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
...
void test_i8_asym(struct csi_tensor *input, struct csi_tensor *alpha, struct csi_tensor *output,
                  struct prelu_params *params, float difference)
{
    printf("test prelu i8 asym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
    ...
    op_test_run(qinput0, qinput1, qoutput, params, sess, real_input, output->data, difference);
}

void test_u8_asym(struct csi_tensor *input, struct csi_tensor *alpha, struct csi_tensor *output,
                  struct prelu_params *params, float difference)
{
    printf("test prelu u8 asym\n");
    struct csi_session *sess = csi_alloc_session();
    sess->base_api = CSINN_LIGHT;
                ...
                struct prelu_params *params, float difference)
{
    ...
    test_i8_sym(input, alpha, output, params, difference);
    test_i16_sym(input, alpha, output, params, difference);
    /* unsupport yet */
    // test_i8_asym(input, alpha, output, params, difference);
    // test_u8_asym(input, alpha, output, params, difference);
}
