...
int main(int argc, char **argv)
{
    ...
    verify_relu_q15(q15_relu_input0, q15_relu_result0, 1024, 0.0f);
    verify_relu_q15(q15_relu_input1, q15_relu_result1, 1024, 0.0f);
    ...
    verify_relu_q15(q15_relu_input8, q15_relu_result3, 1023, 0.0f);
    verify_relu_q15(q15_relu_input9, q15_relu_result4, 1023, 0.0f);
}
