...
def not_equal_f32():
    ...
    std1        = int(np.random.randint(20, high=40, size=1))
    zero_point2 = int(np.random.randint(-60000, high=60000, size=1))
    std2        = int(np.random.randint(20, high=40, size=1))
    ...
    src_out = np.not_equal(src_in1, src_in2)
    ...
    with open("not_equal_data_f32.bin", "wb") as fp:
