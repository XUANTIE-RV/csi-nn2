...
def psroipooling_f32():

    model_file = './psroipooling.prototxt'  # deploy文件
    pretrained = './psroipooling.caffemodel'  # 训练的caffemodel
    ...
    print(np.shape(net.blobs['conv1'].data[...]))
    print(np.shape(net.blobs['pooling'].data[...]))
    ...
    para.append(output_dim)
    para.append(group_size)

    print(para)

    with open("psroipooling_data_f32.bin", "wb") as fp:
