...
def create_model(model_path, lmdb_path='train.lmdb', is_train=True):
    ...
    n.pooling = L.ROIPooling(n.data, n.conv1, spatial_scale=0.0625, pooled_h = 1, pooled_w = 2)
...
create_caffemodel('train.prototxt', 'roipooling.prototxt', '../train.lmdb', 'solver.prototxt', 'roipooling.caffemodel')
