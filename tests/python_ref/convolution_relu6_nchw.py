...
def convolution_relu6_f32():
    ...
    std3        = int(np.random.randint(0, high=10, size=1))
    ...
    t_src_out = fn.conv2d(t_src_in, t_weight, bias=t_bias, stride=(stride_y, stride_x), dilation=(dilation_y, dilation_x))
    t_src_out1 = fn.relu6(t_src_out).numpy()
    ...
    with open("convolution_relu6_nchw_data_f32.bin", "wb") as fp:
