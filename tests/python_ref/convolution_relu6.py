...
def convolution_f32():
    ...
    t_src_out = fn.conv2d(t_src_in, t_weight, bias=t_bias, stride=(stride_y, stride_x), padding=0, dilation=(dilation_y, dilation_x))
    ...
    total_size = (len(src_in_1) + len(src_out_1)) + len(weight_1) + len(bias) + 15
    ...
    with open("convolution_relu6_data_f32.bin", "wb") as fp:
