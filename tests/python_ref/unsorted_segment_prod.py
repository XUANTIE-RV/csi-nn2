...
def unsorted_segment_prod_f32():
    ...
    out_calcu = tf.unsorted_segment_prod(tf.convert_to_tensor(src_in), segment_ids, num_segments)
    ...
    with open("unsorted_segment_prod_data_f32.bin", "wb") as fp:
