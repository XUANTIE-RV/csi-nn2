...
def group_convolution_f32(test_dtype, test_vlen, test_type):
    para = []
    ...
    in_channel = int(np.random.randint(4, high=5, size=1))

    packn = int(getpackn(test_dtype, test_vlen))
    n = int(np.random.randint(6, high=7, size=1))
    # init the input data and parameters
...
if __name__ == '__main__':
    ...
    group_convolution_f32(test_dtype, test_vlen, test_type)
    print("end")
