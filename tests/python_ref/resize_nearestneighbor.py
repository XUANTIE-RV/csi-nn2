...
def resize_nearest_neighbor_f32():
    ...
    out_size_x = int(np.random.randint(128, high=512, size=1))
    out_size_y = int(np.random.randint(128, high=512, size=1))
    ...
    with open("resize_nearestneighbor_data_f32.bin", "wb") as fp:
