...
{
    init_testsuite("Testing function of sigmoid(anole).\n");
    ...
    result_verify_8(reference->data, output_tensor, input->data, difference, in_size, false);
