...
#ifndef _CSI_I805_NNFUNCTIONS_H
#define _CSI_I805_NNFUNCTIONS_H
...
void csi_i805_dwconv2d_opt_u8(uint8_t * input_data,
   ...
   *
   */
void csi_i805_dwconv2d_3x3_opt_u8(uint8_t * input,
                                  uint8_t * kernel,
                                  int32_t * bias,
                                  uint8_t * output,
                                  int32_t  input_zero_point,
...
void csi_i805_elementwise_mul_opt_u8(uint8_t *input_0,
   ...
   *
   */
void csi_i805_softmax_opt_u8(uint8_t * input_data,
                             uint8_t * output_data,
                             int32_t  size,
                             int32_t  out_mult,
                             int32_t  out_shift);
...
void csi_i805_vec_mat_mult_opt_u8(uint8_t * lhs,
   ...
   *
   */
void csi_i805_mat_mult_nt_t_opt_u8(uint8_t * lhs,
                                   uint8_t * rhs,
                                   int32_t * bias,
                                   uint8_t * dst,
                                   int32_t  lhs_row,
