    ...
    if (stride_h == 2 && stride_w == 2) {
        if (kernel_h == 2 && kernel_w == 2) {  // 2x2s2
            if (pad_left == 0 && pad_top == 0) {
                ...
                cb->exec = (elempack % packn == 0) ? shl_rvv_maxpool2x2s2_packn_fp32
            ...
            if (pad_left == 0 && pad_top == 0) {
                ...
                cb->exec = (elempack % packn == 0) ? shl_rvv_maxpool3x3s2_packn_fp32
        ...
        if (kernel_h == 3 && kernel_w == 3) {
            if (pad_left == 1 && pad_top == 1 && pad_right == 1 && pad_down == 1) {
                cb->exec = (elempack % packn == 0) ? shl_rvv_maxpool3x3s1_packn_fp32
