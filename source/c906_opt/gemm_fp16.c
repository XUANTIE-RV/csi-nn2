...
void shl_c906_reorder_kernel_fp16(__fp16* a, __fp16* sa, int m, int k, int ldx)
{
    ...
    asm volatile(
        ...
        :"v0", "v2", "v4", "v6", "v8", "v10", "v12", "v14", "a0", "a1", "a2", "a3", "a4", "a5", "a6", "a7",
...
/*
    ...
    TODO: consider using [vle.v --> vse.v] instead of [vlse.v --> vsse.v], may improve cache hit rate
...
/*
    (1) Algorithm works as follows:
        ...
        n4, n2, n1: vfmacc.vv = kernel_data(v reg - 1row) * input_data(v reg 1col) , reduce sum v reg, add bias

    (2) register definition:
        t0:         i_n
        t1-t5:      i_k  t1-t4:[k8, k4, k2, k1] t5:k8_tmp  because i_k for inner_loop, extract to the outside
        t6:         [ n8_loop ]: hold sa/ kernel_data 1 lines origin address
        a0-a7:      dst, sa, sb addr
        ft0:        [ n8_loop ] : sa / kernel_data
        fa0-fa3:    [ n8_loop ] : sa / kernel_data (sb / input_data) shadow reg  [ n4, n2 n1 ]: output res
        fs0:        hold 1 channels bias_data
        v1-v8:      [ n8_loop ] : sb / input_data   [ n4, n2 n1 ]: sb / kernel_data  and  sb / input_data
...
/*
    ...
    (2) register definition:
        t0:         i_n
        t1-t5:      i_k  t1-t4:[k8, k4, k2, k1] t5:k8_tmp  because i_k for inner_loop, extract to the outside
        t6:         [ n8_loop ]: hold sa/ kernel_data 2 lines origin address
        a0-a7:      dst, sa, sb addr
        ft0-ft1:    [ n8_loop ] : sa / kernel_data
        fa0-fa7:    [ n8_loop ] : sa / kernel_data (sb / input_data) shadow reg  [ n4, n2 n1 ]: output res
        fs0-fs1:    hold 2 channels bias_data
        v1-v8:      [ n8_loop ] : sb / input_data   [ n4, n2 n1 ]: sb / kernel_data  and  sb / input_data
        v24-v31:    bias_tmp and output
                           ...
                           __fp16* bias)
{
    ...
    :"v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31",
     "a0", "a1", "a2", "a3", "a4", "a5", "a6", "a7", "t0", "t1", "t2", "t3", "t4", "t5", "t6",
     "fa0", "fa1", "fa2", "fa3", "fa4", "fa5", "fa6", "fa7", "ft0", "ft1", "fs0", "fs1"
    );
...
/*
    (1) Algorithm works as follows:
        ...
        n8_loop:    vfmacc.vf = kernel_data(f reg) * input_data(v reg)
        n4, n2, n1: vfmacc.vf = kernel_data(v reg) * input_data(f reg)  set vl = 4 (m = 4) , only half throughout capacity

    (2) register definition:
        t0:         i_n
        t1-t5:      i_k  t1-t4:[k8, k4, k2, k1] t5:k8_tmp  because i_k for inner_loop, extract to the outside
        t6:         hold sa/ kernel_data 4 lines origin address
        a0-a3:      dst0-dst3 addr
                           ...
                           __fp16* bias)
{
    ...
    "5"(n),
    "6"(ldc)
    :"v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v24", "v25", "v26", "v27",
     "a0", "a1", "a2", "a3", "a4", "a5", "a6", "a7", "t0", "t1", "t2", "t3", "t4", "t5", "t6",
     "fa0", "fa1", "fa2", "fa3", "ft0", "ft1", "ft2", "ft3", "fs0", "fs1", "fs2", "fs3"
    );
...
/*
    ...
    (2) register definition:
        t0:         i_n
        t1-t5:      i_k  t1-t4:[k8, k4, k2, k1] t5:k8_tmp  because i_k for inner_loop, extract to the outside
        t6:         hold sa/ kernel_data 8 lines origin address
        a0-a7:      dst0-dst7 addr
                           ...
                           __fp16* bias)
{
    ...
    :"v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31",
     "a0", "a1", "a2", "a3", "a4", "a5", "a6", "a7", "t0", "t1", "t2", "t3", "t4", "t5", "t6",
     "fa0", "fa1", "fa2", "fa3", "fa4", "fa5", "fa6", "fa7", "ft0", "ft1", "ft2", "ft3", "ft4", "ft5", "ft6", "ft7", "fs0", "fs1", "fs2", "fs3", "fs4", "fs5", "fs6", "fs7"
    );
