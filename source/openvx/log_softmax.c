                        ...
                        struct softmax_params *params)
{
    ...
    node = vsi_nn_AddNode(graph, VSI_NN_OP_LOG_SOFTMAX, input_num, output_num, &node_id);
    node->nn_param.log_softmax.betaValue = 1.0;
    node->nn_param.log_softmax.axis = input->dim_count - 1 - params->axis;
