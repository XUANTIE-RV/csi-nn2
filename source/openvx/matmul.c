                   ...
                   struct matmul_params *params)
{
    ...
    vsi_nn_graph_t *graph = csi_ovx_get_graph(mat0->sess);
    output->sess = mat0->sess;
    ...
    /* input */
    node->input.tensors[0] = (vsi_nn_tensor_id_t)mat0->data;
    node->input.tensors[1] = (vsi_nn_tensor_id_t)mat1->data;
