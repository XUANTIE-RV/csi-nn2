...
int csi_ovx_tile(struct csi_tensor *input,
                 ...
                 struct tile_params *params)
{
    ...
    node = vsi_nn_AddNode(graph, VSI_NN_OP_TILE, input_num, output_num, &node_id);
    node->nn_param.tile.multiples = params->reps;
    node->nn_param.tile.multiples_num = params->reps_num;
