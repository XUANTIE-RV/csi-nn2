                         ...
                         struct psroipooling_params *params)
{
    ...
    node->nn_param.custom_psroipooling.output_dim = (uint32_t)params->output_dim;
    node->nn_param.custom_psroipooling.group_size = (uint32_t)params->group_size;
    node->nn_param.custom_psroipooling.spatial_scale = params->spatial_scale;
