                  ...
                  struct relu_params *params)
{
    ...
    node = vsi_nn_AddNode(graph, VSI_NN_OP_RELUN, input_num, output_num, &node_id);
    node->nn_param.relun.relu_clamp_top = params->n;
    node->nn_param.relun.relu_clamp_bottom = 0;
