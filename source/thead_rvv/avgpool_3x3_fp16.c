        ...
        for (int c = 0; c < in_c; c++) {
            ...
            for (int h = 0; h < out_h; h++) {
                ...
                while (w > 0) {
                    ...
                    line0 += (vl - 1) * 2;
                    vfloat16m1_t _sum0 =
                        vfadd_vv_f16m1(_line0_2_8, vfadd_vv_f16m1(_line0_0_6, _line0_1_7, vl), vl);
                    ...
                    line1 += (vl - 1) * 2;
                    vfloat16m1_t _sum1 =
                        vfadd_vv_f16m1(_line1_2_8, vfadd_vv_f16m1(_line1_0_6, _line1_1_7, vl), vl);
                    ...
                    line2 += (vl - 1) * 2;
                    vfloat16m1_t _sum2 =
                        vfadd_vv_f16m1(_line2_2_8, vfadd_vv_f16m1(_line2_0_6, _line2_1_7, vl), vl);

                    vfloat16m1_t _sum = vfadd_vv_f16m1(_sum2, vfadd_vv_f16m1(_sum0, _sum1, vl), vl);
    ...
    for (int b = 0; b < batch; b++) {
        for (int c = 0; c < in_c; c++) {
            ...
            while (w > 0) {
                ...
                line1 += vl - 2;
                vfloat16m1_t _sum1 =
                    vfadd_vv_f16m1(_line1_2_5, vfadd_vv_f16m1(_line1_0_3, _line1_1_4, vl), vl);
                ...
                line2 += vl - 2;
                vfloat16m1_t _sum2 =
                    vfadd_vv_f16m1(_line2_2_5, vfadd_vv_f16m1(_line2_0_3, _line2_1_4, vl), vl);

                vfloat16m1_t _sum = vfadd_vv_f16m1(_sum1, _sum2, vl);
                vfloat16m1_t _avg = vfmul_vf_f16m1(_sum, ratio, vl);
                vse16_v_f16m1(outptr, _avg, vl);
            ...
            for (int h = 0; h < out_h - 2; h++) {
                ...
                while (w > 0) {
                    ...
                    line0 += vl - 2;
                    vfloat16m1_t _sum0 =
                        vfadd_vv_f16m1(_line0_2_5, vfadd_vv_f16m1(_line0_0_3, _line0_1_4, vl), vl);
