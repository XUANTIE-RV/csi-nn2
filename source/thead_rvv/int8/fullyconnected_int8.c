...
void shl_rvv_fc_gemm_transform_weight_int8(struct csinn_tensor *weights)
{
    ...
    shl_rvv_reorder_kernel_int8(weight_data, kernel_reorder, n, k);
                                     ...
                                     struct csinn_fc_params *params)
{
    ...
    shl_rvv_reorder_input_m4_int8(input_data, input_reorder, m, k);
    shl_rvv_gemm_4xn_int8(output_data, input_reorder, weights_data, bias_data, m, k, n, n,
