                                        ...
                                        int M, int K, int N)
{
    ...
    for (; i + 7 < M; i += 8) {
        ...
        for (; j + pack2n - 1 < N; j += pack2n) {
            ...
            for (int c = 0; c < K; c++) {
                vfloat32m1_t _a0 = vfmv_v_f_f32m1(a_ptr[0], vl);
                vfloat32m1_t _a1 = vfmv_v_f_f32m1(a_ptr[1 * K], vl);
                vfloat32m1_t _a2 = vfmv_v_f_f32m1(a_ptr[2 * K], vl);
                vfloat32m1_t _a3 = vfmv_v_f_f32m1(a_ptr[3 * K], vl);
                vfloat32m1_t _a4 = vfmv_v_f_f32m1(a_ptr[4 * K], vl);
                vfloat32m1_t _a5 = vfmv_v_f_f32m1(a_ptr[5 * K], vl);
                vfloat32m1_t _a6 = vfmv_v_f_f32m1(a_ptr[6 * K], vl);
                vfloat32m1_t _a7 = vfmv_v_f_f32m1(a_ptr[7 * K], vl);
                a_ptr += 1;
                ...
                _acc00 = vfmacc_vv_f32m1(_acc00, _a0, _b0, vl);
                _acc10 = vfmacc_vv_f32m1(_acc10, _a1, _b0, vl);
                _acc20 = vfmacc_vv_f32m1(_acc20, _a2, _b0, vl);
                _acc30 = vfmacc_vv_f32m1(_acc30, _a3, _b0, vl);
                _acc40 = vfmacc_vv_f32m1(_acc40, _a4, _b0, vl);
                _acc50 = vfmacc_vv_f32m1(_acc50, _a5, _b0, vl);
                _acc60 = vfmacc_vv_f32m1(_acc60, _a6, _b0, vl);
                _acc70 = vfmacc_vv_f32m1(_acc70, _a7, _b0, vl);
                _acc01 = vfmacc_vv_f32m1(_acc01, _a0, _b1, vl);
                _acc11 = vfmacc_vv_f32m1(_acc11, _a1, _b1, vl);
                _acc21 = vfmacc_vv_f32m1(_acc21, _a2, _b1, vl);
                _acc31 = vfmacc_vv_f32m1(_acc31, _a3, _b1, vl);
                _acc41 = vfmacc_vv_f32m1(_acc41, _a4, _b1, vl);
                _acc51 = vfmacc_vv_f32m1(_acc51, _a5, _b1, vl);
                _acc61 = vfmacc_vv_f32m1(_acc61, _a6, _b1, vl);
                _acc71 = vfmacc_vv_f32m1(_acc71, _a7, _b1, vl);
            }
