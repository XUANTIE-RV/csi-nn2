...
static int csi_unsorted_segment_max_f32(struct csi_tensor *input,
...
static int csi_segment_max_f32(struct csi_tensor *input,
                            struct csi_tensor *segment_ids,
                            struct csi_tensor *output,
                            struct segment_params *params)
{
...
static int csi_unsorted_segment_max_u8(struct csi_tensor *input,
                            struct csi_tensor *segment_ids,
                            struct csi_tensor *output,
                            struct segment_params *params)
{
...
static int csi_segment_max_u8(struct csi_tensor *input,
                            struct csi_tensor *segment_ids,
                            struct csi_tensor *output,
                            struct segment_params *params)
{
                     ...
                     struct segment_params *params)
{
    if (input0->dtype == CSINN_DTYPE_UINT8) {
        if (params->unsorted == CSINN_TRUE) {
            params->bc = csi_unsorted_segment_max_u8;
        } else {
            params->bc = csi_segment_max_u8;
        }
    } else if (input0->dtype == CSINN_DTYPE_FLOAT32) {
        if (params->unsorted == CSINN_TRUE) {
            params->bc = csi_unsorted_segment_max_f32;
        } else {
            params->bc = csi_segment_max_f32;
        }
    } else {
