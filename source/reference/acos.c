...
static int csi_acos_f32(struct csi_tensor *input,
...
static int csi_acos_u8(struct csi_tensor *input,
                       struct csi_tensor *output,
                       struct siso_params *params)
{
                    ...
                    struct siso_params *params)
{
    if (input->dtype == CSINN_DTYPE_UINT8) {
        params->bc = csi_acos_u8;
    } else if (input->dtype == CSINN_DTYPE_FLOAT32) {
        params->bc = csi_acos_f32;
    } else {
