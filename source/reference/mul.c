            ...
            for(int h = 0; h < input0->dim[1]; h++){
                for(int w = 0; w < input0->dim[2]; w++){
                    for(int c = 0; c < input0->dim[3]; c++){
                        ...
                        output_data[index] = input0_data[index] * input1_data[c];
                    }
                }
            }
        }
               ...
               struct diso_params *params)
{
    ...
    else if (input0->dim_count == 5 && input1->dim_count == 2){
        for(int i = 0; i < input0->dim[0]; i++){
            for(int j = 0; j < input0->dim[1]; j++){
                for(int k = 0; k < input0->dim[2]; k++){
                    for(int l = 0; l < input0->dim[3]; l++){
